...
public $timestamps = false;
    ...
    {
        return $this->join('fundclass','fundclass.asset','=','goals_assets_allocation.asset')->where('customerid',$customerid)->where('goals_assets_allocation.goalid',$goalid)->where('fundclass.assettype',$assettype)->where('goals_assets_allocation.asset',$asset)->where('goals_assets_allocation.purchase_type',$type)->get()->first();
    }
