...
/**
 * This class stands for sipOrderEntryParam StructType
 * @package SM
 * @subpackage Structs
 */
class SMSipOrderEntryParam extends AbstractStructBase
{
    /**
     * The TransactionCode
    ...
    public $Param3;
    /**
     * Constructor method for sipOrderEntryParam
     * @uses SMSipOrderEntryParam::setTransactionCode()
     * @uses SMSipOrderEntryParam::setUniqueRefNo()
     * @uses SMSipOrderEntryParam::setSchemeCode()
     * @uses SMSipOrderEntryParam::setMemberCode()
     * @uses SMSipOrderEntryParam::setClientCode()
     * @uses SMSipOrderEntryParam::setUserID()
     * @uses SMSipOrderEntryParam::setInternalRefNo()
     * @uses SMSipOrderEntryParam::setTransMode()
     * @uses SMSipOrderEntryParam::setDpTxnMode()
     * @uses SMSipOrderEntryParam::setStartDate()
     * @uses SMSipOrderEntryParam::setFrequencyType()
     * @uses SMSipOrderEntryParam::setFrequencyAllowed()
     * @uses SMSipOrderEntryParam::setInstallmentAmount()
     * @uses SMSipOrderEntryParam::setNoOfInstallment()
     * @uses SMSipOrderEntryParam::setRemarks()
     * @uses SMSipOrderEntryParam::setFolioNo()
     * @uses SMSipOrderEntryParam::setFirstOrderFlag()
     * @uses SMSipOrderEntryParam::setSubberCode()
     * @uses SMSipOrderEntryParam::setEuin()
     * @uses SMSipOrderEntryParam::setEuinVal()
     * @uses SMSipOrderEntryParam::setDPC()
     * @uses SMSipOrderEntryParam::setRegId()
     * @uses SMSipOrderEntryParam::setIPAdd()
     * @uses SMSipOrderEntryParam::setPassword()
     * @uses SMSipOrderEntryParam::setPassKey()
     * @uses SMSipOrderEntryParam::setParam1()
     * @uses SMSipOrderEntryParam::setParam2()
     * @uses SMSipOrderEntryParam::setParam3()
     ...
     * @param string $param3
     */
    public function __construct($transactionCode = null, $uniqueRefNo = null, $schemeCode = null, $memberCode = null, $clientCode = null, $userID = null, $internalRefNo = null, $transMode = null, $dpTxnMode = null, $startDate = null, $frequencyType = null, $frequencyAllowed = null, $installmentAmount = null, $noOfInstallment = null, $remarks = null, $folioNo = null, $firstOrderFlag = null, $subberCode = null, $euin = null, $euinVal = null, $dPC = null, $regId = null, $iPAdd = null, $password = null, $passKey = null, $param1 = null, $param2 = null, $param3 = null)
    {
        $this
     ...
     * @param string $transactionCode
     * @return \SM\StructType\SMSipOrderEntryParam
     */
