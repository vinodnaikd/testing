...
/**
 * This class stands for SpreadOrder StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:SpreadOrder
 * @package SM
 * @subpackage Structs
 */
class SMSpreadOrder extends AbstractStructBase
{
    /**
     * The AllUnitFlag
     * Meta informations extracted from the WSDL
    ...
    public $UserID;
    /**
     * Constructor method for SpreadOrder
     * @uses SMSpreadOrder::setAllUnitFlag()
     * @uses SMSpreadOrder::setBuySell()
     * @uses SMSpreadOrder::setBuySellType()
     * @uses SMSpreadOrder::setClientCode()
     * @uses SMSpreadOrder::setDPC()
     * @uses SMSpreadOrder::setDPTxn()
     * @uses SMSpreadOrder::setEUIN()
     * @uses SMSpreadOrder::setEUINVal()
     * @uses SMSpreadOrder::setFolioNo()
     * @uses SMSpreadOrder::setIPAdd()
     * @uses SMSpreadOrder::setKYCStatus()
     * @uses SMSpreadOrder::setMemberId()
     * @uses SMSpreadOrder::setMinRedeem()
     * @uses SMSpreadOrder::setOrderId()
     * @uses SMSpreadOrder::setOrderVal()
     * @uses SMSpreadOrder::setParam1()
     * @uses SMSpreadOrder::setParam2()
     * @uses SMSpreadOrder::setParam3()
     * @uses SMSpreadOrder::setPassKey()
     * @uses SMSpreadOrder::setPassword()
     * @uses SMSpreadOrder::setRedeemDate()
     * @uses SMSpreadOrder::setRedemptionAmt()
     * @uses SMSpreadOrder::setRefNo()
     * @uses SMSpreadOrder::setRemarks()
     * @uses SMSpreadOrder::setSchemeCd()
     * @uses SMSpreadOrder::setSubBrCode()
     * @uses SMSpreadOrder::setTransCode()
     * @uses SMSpreadOrder::setTransNo()
     * @uses SMSpreadOrder::setUserID()
     ...
     * @param string $userID
     */
    public function __construct($allUnitFlag = null, $buySell = null, $buySellType = null, $clientCode = null, $dPC = null, $dPTxn = null, $eUIN = null, $eUINVal = null, $folioNo = null, $iPAdd = null, $kYCStatus = null, $memberId = null, $minRedeem = null, $orderId = null, $orderVal = null, $param1 = null, $param2 = null, $param3 = null, $passKey = null, $password = null, $redeemDate = null, $redemptionAmt = null, $refNo = null, $remarks = null, $schemeCd = null, $subBrCode = null, $transCode = null, $transNo = null, $userID = null)
    {
        $this
     ...
     * @param string $allUnitFlag
     * @return \SM\StructType\SMSpreadOrder
     */
