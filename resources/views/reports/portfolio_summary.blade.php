	...
	#customers th {
	  ...
	  padding-bottom: 12px;
	  text-align: left;
	  background-color: #4281f5; /*#4CAF50;*/
	  color: white;
	} 
	label{
		color:#4281f5;
	...
	<div style="flex-grow:4;">
	<h3 style="color:#4281f5;padding: 1%;">Report as on 31-Mar-2015</h3>	
	</div>
	<div style="flex-grow:2;">
	<img  style="padding-top:10px" src="http://dev-app.savingsmanager.co.in/assets/images/savings-manager-logo.png" />	
	</div>
	</header>

	<hr style="height:3px;background-color:black;">
	<div class="list1">
	<div style="flex-grow:5;display:flex;">
	...
	<ul>
		...
		<li>: (+91) 9870308936</li>
		<li>: LO-48 LIGI ST, SECTOR-3, KALAMBOLI, RAIGAD- 410218SECTOR-3KALAMBOLI</li>
		
	</ul>
	</div>
	</div>
	<div style="flex-grow:5;align-items:center;justify-content:center;">
	<ul>
...
<hr style="height:1.5px;background-color:black;">
	<table id="customers">
	  ...
	  <h2>Ashok Mhatre</h2>
	  Birla Sun Life Mutual Fund<br><br>
	  Birla SL Tax Relief '96(G) - Equity [1015447155]<br><br>
	  <tr>
		<td>PURCHASE</td>
		<td>01 Jun 2010</td>
		<td>10.6200</td>
